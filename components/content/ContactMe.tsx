...
const ContactMe = () => {
  return (
    <AnimationContainer customClassName='w-full'>
      ...
      <div className='w-full flex justify-between items-centoer flex-col mx-auto max-w-screen-xl'>

        <div className='w-full flex justify-between items-center flex-col lg:flex-row gap-6 mb-10'>

          <a href='mailto:tranquoctrung270302@gmail.com' target='_blank' rel='noreferrer' className='w-full'>
            <div className='rounded border border-gray-800 hover:border-gray-900 bg-[#080809] p-4 shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] sm:p-6 transition ease'>
              ...
              <p className='text-base mt-62 text-gray-400'>
                tranquoctrung270302@gmail.com
              </p>
            </div>
          </a>

          <a href="https://www.linkedin.com/in/tranquoctrung2703/" target='_blank' rel='noreferrer' className='w-full'>
            <div className='rounded border border-gray-800 hover:border-gray-900 bg-[#080809] p-4 shadow-sm hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] sm:p-6 transition ease'>
              <h6 className='font-bold text-1xl tracking-tight text-white text-start'>
                LinkedIn
              </h6>
