      ...
      <div className='w-full flex flex-col justify-center items-start rounded gap-5'>
        ...
        <div className='w-full flex justify-between items-start flex-wrap flex-col lg:flex-row gap-5'>
          ...
          <div className='flex justify-center items-end gap-3'>
            ...
            <ExternalLink href={repo} customClassName='text-white inline-flex items-center rounded-lg bg-gray-500 p-2 hover:bg-gray-800 transition-all ease'>
            ...
            <ExternalLink href={link} customClassName='text-white inline-flex items-center rounded-lg bg-green-600 p-2 hover:bg-green-900 transition-all ease'>
