  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-end gap-3'> 
        ...
        <ExternalLink href={repo} customClassName='text-white inline-flex items-center rounded-lg bg-gray-500 p-2 hover:bg-gray-800 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
        ...
        <ExternalLink href={link} customClassName='text-white inline-flex items-center rounded-lg bg-green-600 p-2 hover:bg-green-900 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
