  ...
  return (
    <>
      ...
      >
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
          <div className='transition duration-200 brightness-100 hover:brightness-50'>
            <svg xmlns="http://www.w3.org/2000/svg" width="32px" height="32px" viewBox="0 0 96 96" fill='currentColor'>
              <title>Azure</title>
              <defs>
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
          <div className='transition duration-200 brightness-100 hover:brightness-50'>
            <Image src='/skills/kafka.svg' alt=' ' width={56} height={56} title="Kafka"/>
          </div>
        </motion.li>
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
          <div className='transition duration-200 brightness-100 hover:brightness-50'>
            <Image src='/skills/power_bi.svg' alt=' ' width={32} height={32} title="PowerBI"/>
          </div>
        </motion.li>
